...
import { Camera, Upload, Sparkles, AlertCircle, CheckCircle, Pill, Apple, Info, ArrowRight, Zap, Activity, Cpu, Droplets, TrendingUp, BarChart3 } from 'lucide-react';
...
export default function NutritionalDeficiencyDetector() {
  ...
  const getSeverityColor = (severity) => {
    if (severity >= 70) return { bg: 'bg-red-500', border: 'border-red-500', text: 'text-red-400' };
    if (severity >= 50) return { bg: 'bg-yellow-500', border: 'border-yellow-500', text: 'text-yellow-400' };
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute w-[350px] h-[350px] rounded-full blur-[100px] opacity-20 animate-float-slow"
             style={{ background: 'radial-gradient(circle, rgba(59, 130, 246, 0.6), transparent)', bottom: '15%', left: '30%', transform: `translate(${mousePosition.x * 0.08}px, ${mousePosition.y * 0.08}px)`, animationDelay: '4s' }} />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-6 py-16 max-w-7xl">
        ...
        {!image ? (
          ...
          <div className="space-y-8 animate-slide-up">
            ...
            {/* Deficiencies with Data Visualization */}
                    ...
                    <div key={idx} className="relative group" style={{ animationDelay: `${idx * 150}ms` }}>
                      ...
                      <div className="relative rounded-3xl border-2 border-purple-500/30 bg-black/60 backdrop-blur-2xl overflow-hidden hover:border-purple-500/50 transition-all duration-700">
                        ...
                        <div className="p-10 space-y-10">
                          {/* Symptoms with Count Visualization */}
